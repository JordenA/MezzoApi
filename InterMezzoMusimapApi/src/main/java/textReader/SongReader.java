...
public class SongReader {
	...
	/**
	 * This method generates an array of song from the MUSIMAP API.
	 * When we ask for the api for songs we get a list of 10, and here we make the string into objects
	 * 
	 * @param strToRead the output of the MUSIMAP API about 10 songs that match user likes
