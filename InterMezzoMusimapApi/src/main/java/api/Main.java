...
public class Main {
	...
	public static void main(String[] args) throws Exception { 
		...
		songArr=SongReader.getSong(str);
	...
	public static void updatelike(boolean isLiked) { // send song to gui
		...
		if (songCounter<=9) ////
		{
			//System.out.println("choices:   "+check);
...
//			for(int i=0;i<10;i++) { 
//			System.out.println(songArr[i].isLike());			
//			}
//			
//			System.out.println("choices:   "+check);
			Fitness.fitness();
...
//	public static String getSongNameYoutube() {
//		return songNameYoutube;
//	}
//
//
//	public static void setSongNameYoutube(String songNameYoutube) {
//		Main.songNameYoutube = songNameYoutube;
//	}
//	
//	public static String getArtistNameYoutube() {
//		return artistNameYoutube;
//	}
//
//
//	public static void setArtistNameYoutube(String artistNameYoutube) {
//		Main.artistNameYoutube = artistNameYoutube;
//	}
